        ...
        >
          <v-list-item three-line>
            ...
            <v-list-item-content>
              ...
              >{{ member.headline }}</v-list-item-subtitle>
              <v-list-item-content
                class="hidden-sm-and-down"
              >{{ member.about }}</v-list-item-content>
            </v-list-item-content>
            <v-list-item-avatar
              v-if="index % 2 !== 0"
              size="100"
  ...
  data () {
    return {
      members: [
        ...
        { id: 2, name: 'Jonathan Landers', picture: '/img/jonathan.jpg', headline: 'Active Member', about: 'My name is Jonathan Landers, I am a Mechanical Engineering student at OSU/LBCC. I work on everything that needs to be done in mechanical, CAD, design, and 3D printing.', teams: ['mechanical'] },
        { id: 3, name: 'John Warila', picture: 'img/john.jpg', headline: 'Active Member', about: 'I\'m John Warila, a Computer Science Student at OSU/LBCC. I am our primary web-developer and help with some of the ECE and design work for the prosthetic.', teams: ['software', 'admin'] },
        { id: 4, name: 'Mico Santiago', picture: 'img/mico.jpg', headline: 'Active Member', about: 'My name is Mico Santiago, pre-med student at OSU/LBCC where I am studying Biological Engineering. My responsibilities is administration and social outreach. I was a former pro tennis player and I aspire to save lives as a doctor.', teams: ['admin'] }
      ]
    }
  }
}
